...
interface FormatValidator {
   ...
   *
   * Формат: каждая строка должна содержать имя и возраст, разделённые запятой. Например: "Иван,25"
   *
...
fun validateLine(line: String, lineNumber: Int) {
  ...
  if (parts.size != 2) {
    throw InvalidFileFormatException(
        "[Строка $lineNumber] Указаны менее или более двух значений на строке"
    )
  }
