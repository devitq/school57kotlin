...
abstract class FileAnalyzerTest {
  ...
  fun `should count lines and words correctly`() {
    ...
    val result =
        analyzer.countLinesAndWordsInFile(tempInputFile.absolutePath, tempOutputFile.absolutePath)
  ...
  fun `should return false if input is a directory`() {
    ...
    val result =
        analyzer.countLinesAndWordsInFile(inputDir.absolutePath, tempOutputFile.absolutePath)
  ...
  fun `should return false if output is a directory`() {
    ...
    val result =
        analyzer.countLinesAndWordsInFile(tempInputFile.absolutePath, outputDir.absolutePath)
