 ...
 *
 * Дано: список Order, у каждого есть список OrderItem (productId, quantity, pricePerUnit). Нужно:
 * получить ПЛОСКИЙ список LineItem с вычисленной суммой (quantity * pricePerUnit), а также добавить
 * поле orderId и итог с налогом TAX 20% (totalWithTax).
 *
 * Подсказки:
